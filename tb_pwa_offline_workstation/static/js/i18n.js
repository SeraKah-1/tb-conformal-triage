...
const I18N_DICT = {
    en: {
        ...
        uploadDesc: "PNG and JPEG supported (exported DICOM frames). Automated quality assurance applied.",
        ...
        rejectColorTitle: "Full-Color Image / Non-Radiograph Detected",
        rejectColorDesc: "This CAD system is strictly calibrated for monochrome frontal chest radiographs only. Color photographs and everyday objects are rejected.",
        rejectDocTitle: "Invalid Thoracic Anatomy / Document Detected",
        rejectDocDesc: "Grayscale distribution indicates a text document, blank page, or corrupted image.",
        rejectContrastTitle: "Low Image Dynamic Range / Contrast",
        rejectContrastDesc: "Image is flat, overexposed, or washed out; fine lung textures cannot be resolved.",
        rejectAspectTitle: "Invalid Aspect Ratio",
        rejectAspectDesc: "Aspect ratio is outside valid thoracic anatomy range (0.65 - 1.55).",
        rejectResTitle: "Insufficient Resolution",
        rejectResDesc: "Minimum 256x256 pixel resolution required to resolve subtle infiltrates.",
        rejectCompressionTitle: "Severe Compression Artifacts Detected",
        rejectCompressionDesc: "Elevated lossy compression grid distortion risks generating false reticular patterns.",
        actionRejectBadge: "PRE-ANALYTIC REJECTION",
        actionOodBadge: "DISTRIBUTION ANOMALY (OOD)",
        actionOodTitle: "Image Out-Of-Distribution (OOD Anomaly)",
        actionOodDesc: "Latent feature representation diverges from thoracic reference population. Expert physician review mandatory."
    },
    id: {
        ...
        uploadDesc: "Mendukung format PNG dan JPEG (ekspor DICOM standar). Pemeriksaan kualitas citra otomatis.",
        ...
        rejectColorTitle: "Citra Berwarna / Bukan Rontgen Toraks",
        rejectColorDesc: "Sistem ini secara khusus dikalibrasi hanya untuk rontgen dada frontal (monochrome). Foto berwarna atau objek umum tidak dapat dianalisis.",
        rejectDocTitle: "Anatomi Tidak Valid / Dokumen Teks",
        rejectDocDesc: "Pola keabuan mengindikasikan dokumen teks, halaman kosong, atau citra rusak.",
        rejectContrastTitle: "Kontras Citra Terlalu Rendah",
        rejectContrastDesc: "Citra terlalu datar, overexposed, atau kosong sehingga tekstur paru tidak terbaca.",
        rejectAspectTitle: "Rasio Dimensi Tidak Valid",
        rejectAspectDesc: "Rasio aspek citra berada di luar batas anatomis toraks frontal (0.65 - 1.55).",
        rejectResTitle: "Resolusi Citra Terlalu Rendah",
        rejectResDesc: "Resolusi minimal 256x256 piksel diperlukan untuk mendeteksi infiltrat halus.",
        rejectCompressionTitle: "Artefak Kompresi Gambar Terlalu Tinggi",
        rejectCompressionDesc: "Distorsi grid kompresi lossy berlebih berisiko menimbulkan artefak retikular semu.",
        actionRejectBadge: "DITOLAK SISTEM (PRA-ANALITIK)",
        actionOodBadge: "ANOMALI DISTRIBUSI (OOD)",
        actionOodTitle: "Citra Berada di Luar Distribusi Rontgen Toraks",
        actionOodDesc: "Representasi fitur laten citra menyimpang dari populasi kalibrasi rontgen toraks. Wajib telaah dokter spesialis."
    }
};
